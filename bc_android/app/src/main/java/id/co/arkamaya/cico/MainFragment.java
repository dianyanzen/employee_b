...
*//*
                    ...
                    txtPlace.setText(m.getPlace().toString());
                    int idxLocation = dataAdapterLocation.getPosition(m.getScheduleType().toString());
                    spnLocationType.setSelection(idxLocation);
                    txtProject.setText(m.getScheduleProject().toString());
                    txtNotes.setText(m.getScheduleDescription().toString());
*//*

                    inputObjectState(false);

                    if (m.getClockOut().toString().equals("00:00")) {
                        if (m.getClockIn().toString().equals("00:00")) {
